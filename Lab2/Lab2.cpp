...
// Объявление переменной для хранения выбранной формы объекта (0 - круг, 1 - квадрат)
int selectedShape = 0;
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) 
{
    ...
    case WM_CREATE:
        ...
        CreateWindow(L"BUTTON", L"Circle", WS_CHILD | WS_VISIBLE, 65, 90, 100, 30, hwnd, (HMENU)1, hInst, NULL);
        CreateWindow(L"BUTTON", L"Square", WS_CHILD | WS_VISIBLE, 175, 90, 100, 30, hwnd, (HMENU)2, hInst, NULL);
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow) 
{
    ...
    // Создание окна с заголовком "Графическое приложение"
